...
// activeByProject index can still be empty after that returns.
func (b *BillingAccountBindingCache) HasSynced() bool {
	return b.handlerReg != nil && b.handlerReg.HasSynced()
}
